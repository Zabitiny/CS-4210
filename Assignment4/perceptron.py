...
# SPECIFICATION: Neural netowrks practice
...
for w in n: #iterates over n
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            if newAccuracy > accuracy and a == 0:
               print("Highest Perceptron accuracy so far: {}, Parameters: learning rate={}, shuffle={}".format(newAccuracy, w, b))
            elif newAccuracy > accuracy and a == 1:
               print("Highest MLP accuracy so far: {}, Parameters: learning rate={}, shuffle={}".format(newAccuracy, w, b))
