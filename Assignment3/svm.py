...
# AUTHOR: Zack Muraca
# FILENAME: svm
# SPECIFICATION: Support Vector Machine practice
...
for penalty in c: #iterates over c
    for d in degree: #iterates over degree
        for k in kernel: #iterates kernel
           for s in decision_function_shape: #iterates over decision_function_shape
                ...
                clf = svm.SVC(C = penalty, kernel=k, degree=d, decision_function_shape=s)
                ...
                if accuracy > highestAccuracy:
                    ...
                    print('SVM accuracy so far:', highestAccuracy, 
                        'Parameters: c='+str(penalty), 'degree='+str(d), 'kernel='+k, 'decision_function_shape='+s)
